		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Proposal System New",
									"targetURL": "#nsproposalnew-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsproposalnew-display": {
								"semanticObject": "nsproposalnew",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.proposalnew",
									"url": sap.ui.require.toUrl("ns/proposalnew")
								}
							}
						}
					}
