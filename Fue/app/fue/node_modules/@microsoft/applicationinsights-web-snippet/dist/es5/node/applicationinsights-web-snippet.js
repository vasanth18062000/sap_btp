/*!
 * Application Insights JavaScript SDK - Web Snippet, 1.2.2
...
(function (global, factory) {
    ...
    function _escapeUnsupportedChars(value) {
        if (value) {
    ...
    function _ensureBoolean(value) {
        if (value !== undefined) {
            value = !!value;
        }
        return value;
    }
    function _ensureNumber(value) {
        if (value !== undefined) {
            value = Number(value);
        }
        return value;
