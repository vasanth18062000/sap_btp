 ...
 */
const retrieveUI5VersionsCache = async (type, useCache = false, snapshotUrl) => {
    let versions = [];
    let support = [];
    if (!useCache) {
        switch (type) {
            ...
            case "support" /* ui5VersionsType.support */:
                ...
                return type === "officialVersions" /* ui5VersionsType.official */ ? versions : support;
    ...
    if (constants_1.ui5VersionsCache[type].length === 0) {
        switch (type) {
            case "officialVersions" /* ui5VersionsType.official */:
            case "support" /* ui5VersionsType.support */:
                ({ versions, support } = await parseUI5VersionsAndSupport());
