		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "royaldealer_ui",
									"targetURL": "#royaldealerui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"royaldealerui-display": {
								"semanticObject": "royaldealerui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=royaldealerui",
									"url": sap.ui.require.toUrl("royaldealerui")
								}
							}
						}
					}
